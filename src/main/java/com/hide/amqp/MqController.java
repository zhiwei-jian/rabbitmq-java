...
//    RabbitTemplate rabbitTemplate;
    ...
    public boolean sendTopicMsg(@RequestParam("routingKey") String routingKey, @RequestBody List<User> users)
            throws Exception {
        Map<String, Object> properties = new HashMap<>();
        properties.put("method", "topic");
        rabbitSender.send(users.get(0), properties, "user.abcd");
        return true;
    }
